...
namespace URI_Iniciante_1009_SalarioComBonus {
    class Program {
        static void Main(string[] args) {

           
            double salarioFixo,comissaoVenda, totalVendas;
            ...
            comissaoVenda = ((15 / 100.0)*totalVendas)+salarioFixo;
            Console.WriteLine("TOTAL = R$ "+comissaoVenda.ToString("F2",CultureInfo.InvariantCulture));
